...
function sendConfirmationEmail(data) {
  ...
  var plainText = 
    ...
    "3. Campus Check-in: Report at AVCOE campus on 23 October 2026 with your Team ID.\n\n" +
  ...
  var htmlBody = 
    ...
    '          <li style="margin-bottom: 6px;"><strong>Offline Hackathon:</strong> Report at AVCOE campus on 23 October 2026.</li>' +
    '        </ol>' +
