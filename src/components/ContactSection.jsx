        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 justify-between items-start">
          ...
          <div className="flex flex-col gap-4 w-full md:w-auto min-w-[200px]">
            <button
              ...
              className="w-full px-8 py-4 bg-[#faf9f6] hover:bg-white border-2 border-[#062b59] text-[#062b59] font-bold text-sm uppercase tracking-wider text-center transition-colors rounded-lg shadow-xs cursor-pointer focus:outline-none"
            >
              CONTACT US
            </button>
            <Link
